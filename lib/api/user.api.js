...
userApi.get("/:id/data", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userData.data) {
        ...
        try {
            ...
            if (coins.data.state == "success") {
                ...
                let userPortfolioSearch = data.map(value => (Object.assign(Object.assign({}, value), { amount: assets[value.name.toLowerCase()] != undefined ? assets[value.name.toLowerCase()] : 0 })));
                ...
                let userPortfolio = data
                    ...
                    return Object.assign(Object.assign({}, value), { amount: assets[value.name.toLowerCase()], amount_in_current_price: assets[value.name.toLowerCase()] * value.current_price });
                });
                res.json({
                    state: "success",
                    data: {
