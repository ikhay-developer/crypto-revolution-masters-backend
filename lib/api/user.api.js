        ...
        if (snapshot.exists()) {
            ...
            if (coins.data.state == "success") {
                ...
                data = data
                    ...
                    .map(value => (Object.assign(Object.assign({}, value), { amount: assets[value.name.toLowerCase()], amount_in_current_price: assets[value.name.toLowerCase()] * value.current_price })));
