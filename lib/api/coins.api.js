...
const fetchCoinsFromCoingecko = (pageList) => { var pageList_1, pageList_1_1; return __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (pageList_1 = __asyncValues(pageList); pageList_1_1 = yield pageList_1.next(), !pageList_1_1.done;) {
            ...
            try {
                const coingeckoApi = yield axios_1.default.get(`https://pro-api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=250&page=${page}&sparkline=false&price_change_percentage=1h&x_cg_pro_api_key=CG-yT2kvLSBNH83P7vLxQCbwWtT`);
