...
coinsApi.get("/", (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const coingeckoApi = yield axios_1.default.get("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=2000&page=1&sparkline=false&price_change_percentage=1h");
